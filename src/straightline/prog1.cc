...
A::Stm *Prog() {
    // a = 5 + 3;
    A::Stm *ass_stm1 =
        new A::AssignStm("a", new A::OpExp(new A::NumExp(5), A::PLUS, new A::NumExp(3)));
...
A::Stm *ProgProg() {
    ...
    // a = 5 + b;
    A::Stm *ass_stm1 =
        new A::AssignStm("a", new A::OpExp(new A::NumExp(5), A::PLUS, new A::IdExp("b")));

    // print(a, a, a-1)
    A::Exp *exp1 = new A::OpExp(new A::IdExp("a"), A::MINUS, new A::NumExp(1));

    auto exp_list2 = new A::PairExpList(
        new A::IdExp("a"), new A::PairExpList(new A::IdExp("a"), new A::LastExpList(exp1)));

    // 10 * a
    A::Exp *exp2 = new A::OpExp(new A::NumExp(10), A::TIMES, new A::IdExp("a"));

    // b = (print(a, a, a-1), 10*a);
    A::Stm *ass_stm2 = new A::AssignStm("b", new A::EseqExp(new A::PrintStm(exp_list2), exp2));

    // print b;
    A::Stm *pr_stm2 = new A::PrintStm(new A::LastExpList(new A::IdExp("b")));

    return new A::CompoundStm(stm1,
...
A::Stm *RightProg() {
    ...
    return new A::CompoundStm(
        stm1, new A::AssignStm(
                  "a", new A::EseqExp(new A::AssignStm("a", new A::OpExp(new A::IdExp("a"), A::PLUS,
                                                                         new A::IdExp("b"))),
                                      new A::IdExp("a"))));
}
