...
namespace assem {
    ...
    public:
        ...
        OperInstr(std::string assem, temp::TempList *dst, temp::TempList *src, Targets *jumps)
        ...
        bool unconditional_jump; // 表示这条指令是不是无条件跳转
    };
