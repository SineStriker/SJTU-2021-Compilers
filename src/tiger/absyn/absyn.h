...
namespace absyn {
    ...
    public:
        ...
        void SemAnalyze(env::VEnvPtr venv, env::TEnvPtr tenv, err::ErrorMsg *errormsg) const;
        tr::ExpAndTy Translate(env::VEnvPtr venv, env::TEnvPtr tenv, tr::Level *level,
    ...
    public:
        ...
        virtual type::Ty *SemAnalyze(env::VEnvPtr venv, env::TEnvPtr tenv, int labelcount,
                                     err::ErrorMsg *errormsg) const = 0;
        virtual tr::ExpAndTy Translate(env::VEnvPtr venv, env::TEnvPtr tenv, tr::Level *level,
                                       temp::Label *label, err::ErrorMsg *errormsg) const = 0;
    ...
    public:
        ...
        tr::ExpAndTy Translate(env::VEnvPtr venv, env::TEnvPtr tenv, tr::Level *level,
                               temp::Label *label, err::ErrorMsg *errormsg) const override;
    ...
    public:
        ...
        FieldVar(int pos, Var *var, sym::Symbol *sym) : Var(pos), var_(var), sym_(sym) {
        }
        ~FieldVar() override;
    ...
    public:
        ...
        SubscriptVar(int pos, Var *var, Exp *exp) : Var(pos), var_(var), subscript_(exp) {
        }
    ...
    public:
        ...
        CallExp(int pos, sym::Symbol *func, ExpList *args) : Exp(pos), func_(func), args_(args) {
            assert(args);
        }
        ~CallExp() override;
    ...
    public:
        ...
        WhileExp(int pos, Exp *test, Exp *body) : Exp(pos), test_(test), body_(body) {
        }
        ~WhileExp() override;
    ...
    public:
        ...
        LetExp(int pos, DecList *decs, Exp *body) : Exp(pos), decs_(decs), body_(body) {
        }
        ~LetExp() override;
    ...
    public:
        ...
        virtual void SemAnalyze(env::VEnvPtr venv, env::TEnvPtr tenv, int labelcount,
                                err::ErrorMsg *errormsg) const = 0;
        virtual tr::Exp *Translate(env::VEnvPtr venv, env::TEnvPtr tenv, tr::Level *level,
                                   temp::Label *label, err::ErrorMsg *errormsg) const = 0;
        virtual void Traverse(esc::EscEnvPtr env, int depth) = 0;
    ...
    public:
        ...
        FunctionDec(int pos, FunDecList *functions) : Dec(pos), functions_(functions) {
        }
    ...
    public:
        ...
        virtual ~Ty() = default;
        virtual void Print(FILE *out, int d) const = 0;
        virtual type::Ty *SemAnalyze(env::TEnvPtr tenv, err::ErrorMsg *errormsg) const = 0;
        virtual type::Ty *Translate(env::TEnvPtr tenv, err::ErrorMsg *errormsg) const = 0;
    ...
    public:
        ...
        void Print(FILE *out, int d) const override;
        type::Ty *SemAnalyze(env::TEnvPtr tenv, err::ErrorMsg *errormsg) const override;
        type::Ty *Translate(env::TEnvPtr tenv, err::ErrorMsg *errormsg) const override;
    };
    ...
    public:
        ...
        void Print(FILE *out, int d) const;
        type::TyList *MakeFormalTyList(env::TEnvPtr tenv, err::ErrorMsg *errormsg) const;
        type::FieldList *MakeFieldList(env::TEnvPtr tenv, err::ErrorMsg *errormsg) const;
    ...
    public:
        ...
        [[nodiscard]] const std::list<Exp *> &GetList() const {
            return exp_list_;
        }
        void Print(FILE *out, int d) const;
    ...
    public:
        DecList() = default;
        explicit DecList(Dec *dec) : dec_list_({dec}) {
            assert(dec);
        }
        ...
        [[nodiscard]] const std::list<Dec *> &GetList() const {
            return dec_list_;
        }
        void Print(FILE *out, int d) const;
    ...
    class NameAndTyList {
    public:
        explicit NameAndTyList(NameAndTy *name_and_ty) : name_and_ty_list_({name_and_ty}) {
        }
