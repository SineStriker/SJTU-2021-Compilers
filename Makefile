...
docker-run:
	docker run -it --privileged -p 2222:23 \
		-v /home/functioner/Documents/GitHub/SJTU_Labs/compilers-2021:/home/stu/tiger-compiler 
		ipadsse302/tigerlabs_env:latest

docker-run-backend:
	docker run -dt --privileged -p 2222:23 \
		-v /home/functioner/Documents/GitHub/SJTU_Labs/compilers-2021:/home/stu/tiger-compiler ipadsse302/tigerlabs_env:latest
